...
export default function CargoServicesLanding() {
  ...
  return (
    <div 
      className="min-h-screen w-full m-0 p-0 bg-cover bg-center bg-no-repeat flex items-center justify-center"
      style={{
        backgroundImage: `url("https://images.unsplash.com/photo-1563132331-861c2fd9683e?auto=format&fit=crop&w=1600&q=80")`,
      }}
    >
      <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg max-w-md w-full text-center">
